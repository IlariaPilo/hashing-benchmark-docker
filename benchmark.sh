...
# python3 edit_benchmark.py 1 20 "MWHC" "Exotic" "Chained" "Biased" 0 0 0

# python3 edit_benchmark.py 1 20 "BitMWHC" "Exotic" "Chained" "Balanced" 0 0 0

#  python3 edit_benchmark.py 1 100 "RMIHash" "Model" "Chained" "Balanced" 0 100 1024 

# python3 edit_benchmark.py 4 15 "MWHC" "Exotic" "Cuckoo" "Biased" 5 0 0

# python3 edit_benchmark.py 1 50 "MURMUR" "Traditional" "Linear" "Balanced" 0 0 0
...
#         do
#             echo "Start Here" $bucket_size 100 $model_name "Model" "Chained" "Balanced" 0 $num_models 10024 >>kapil_results.json
#             echo "Start Here" $bucket_size 100 $model_name "Model" "Chained" "Balanced" 0 $num_models 10024 >>hash_comp_stats.out
#             python3 edit_benchmark.py $bucket_size 100 $model_name "Model" "Chained" "Balanced" 0 $num_models 10024
#             bash run.sh >>hash_comp_stats.out
#             cat benchmark_results.json >>kapil_results.json
#         done
#     done
...
#         do
#             echo "Start Here" $bucket_size 100 $model_name "Model" "Chained" "Balanced" 0 1 $max_error >>kapil_results.json
#             echo "Start Here" $bucket_size 100 $model_name "Model" "Chained" "Balanced" 0 1 $max_error >>hash_comp_stats.out
#             python3 edit_benchmark.py $bucket_size 100 $model_name "Model" "Chained" "Balanced" 0 1 $max_error
#             bash run.sh >>hash_comp_stats.out
#             cat benchmark_results.json >>kapil_results.json
#         done
#     done
...
#             python3 edit_benchmark.py $bucket_size $overalloc $model_name "Exotic" "Chained" "Balanced" 0 0 0
#             bash run.sh >>hash_comp_stats.out
#             cat benchmark_results.json >>kapil_results.json
#         done
#     done
...
# # python3 edit_benchmark.py 1 50 RMIHash Model Linear Balanced 0 1000 1024
...
#             python3 edit_benchmark.py $bucket_size $overalloc $model_name "Model" "Linear" "Balanced" 0 1 10024
...
#             python3 edit_benchmark.py $bucket_size $overalloc $model_name "Model" "Chained" "Balanced" 0 1 10024
#             bash run.sh >>data_stats_mar14.out
#             cat benchmark_results.json >>kapil_results.json
#         done
#     done
...
#             python3 edit_benchmark.py $bucket_size $overalloc $model_name "Model" "Cuckoo" "Balanced" 0 1000 1024
#             bash run.sh >>data_stats_mar14.out
#             cat benchmark_results.json >>kapil_results.json
#         done
#     done
...
#             python3 edit_benchmark.py $bucket_size $overalloc $model_name "Model" "Cuckoo" "Balanced" 0 100000 32
#             bash run.sh >>data_stats_mar14.out
#             cat benchmark_results.json >>kapil_results.json
#         done
#     done
...
#             python3 edit_benchmark.py $bucket_size $overalloc $model_name "Traditional" "Cuckoo" "Balanced" 0 0 0
#             bash run.sh >>data_stats_mar14.out
#             cat benchmark_results.json >>kapil_results.json
#         done
#     done
...
#             python3 edit_benchmark.py $bucket_size $overalloc $model_name "Model" "Cuckoo" "Biased" 5 1000 1024
#             bash run.sh >>data_stats_mar14.out
#             cat benchmark_results.json >>kapil_results.json
#         done
#     done
...
#         for model_name in "RMIHash" "RadixSplineHash" 
#         do
#             echo "Start Here" $bucket_size $overalloc $model_name "Model" "Cuckoo" "Biased" 5 100 1024 >>kapil_results.json
